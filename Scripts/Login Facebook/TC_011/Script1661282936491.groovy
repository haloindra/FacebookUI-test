...
WebUI.click(findTestObject('Object Repository/Login Object/Page_Forgotten Password  Cant Log In  Facebook/button_Search'))

WebUI.click(findTestObject('Object Repository/Login Object/Page_Forgotten Password  Cant Log In  Facebook/input_l_recover_method'))

WebUI.click(findTestObject('Object Repository/Login Object/Page_Forgotten Password  Cant Log In  Facebook/input_How do you want to receive the code t_77a821'))
